# simulator
Our work makes use of Inria's Batsim (https://batsim.readthedocs.io/) simulator. We have added a node fault model with repair times, checkpointing, reservations, and some work with cores.  To this is also a framework for spinning up simulations and for post processing.
